...
class MouseEpicsMotor(EpicsMotor):
...
class SampleStageYZ(Device):
    ...
    y = Cpt(MouseEpicsMotor, "ysam")
    z = Cpt(MouseEpicsMotor, "zsam")
...
class Slit(PseudoPositioner):  # Device
    ...
    top = Cpt(MouseEpicsMotor, "top")
    bot = Cpt(MouseEpicsMotor, "bot")
    left = Cpt(MouseEpicsMotor, "hl")
    right = Cpt(MouseEpicsMotor, "hr")
...
class BeamStop(Device):
    ...
    bsr = Cpt(MouseEpicsMotor, "bsr")
    bsz = Cpt(MouseEpicsMotor, "bsz")
...
class DetectorMotions(Device):
    ...
    x = Cpt(MouseEpicsMotor, "detx")
    y = Cpt(MouseEpicsMotor, "dety")
    z = Cpt(MouseEpicsMotor, "detz")
